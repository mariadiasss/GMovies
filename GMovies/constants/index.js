...
export const personData = {
  ...
  knownFor: 'Atuar',
  popularity: 89,
  biography: 'Joaquin Rafael Phoenix, nascido Joaquín Rafael Bottom (San Juan, Porto Rico, 28 de outubro de 1974) é um ator, produtor e ativista Portoriquenho. Por seu trabalho como ator, Phoenix recebeu um Grammy, dois Globo de Ouro e quatro indicações ao Oscar, vencendo como melhor ator na cerimônia de 2020 por sua atuação em Joker (2019). Ele recebeu atenção internacional por sua interpretação de Commodus no épico histórico Gladiador (2000), que lhe rendeu uma indicação ao Oscar de Melhor Ator Coadjuvante. Posteriormente, recebeu indicações para Melhor Ator por interpretar o músico Johnny Cash na cinebiografia Walk the Line (2005).'
}