    ...
    >
      ...
      <SafeAreaView className={"z-20 w-full flex-row justify-between items-center p-4 pt-3"}>
        ...
        <TouchableOpacity onPress={() => toggleFavorite(!isFavorite)}>
          <HeartIcon size="35" color={isFavorite ? theme.background : "white"} /></TouchableOpacity>
      </SafeAreaView>
      ...
      <View>
        ...
        <View className="my-6 mx-4 space-y-2">
          ...
          <Text className="text-neutral-400 tracking-wide">
            Joaquin Rafael Phoenix, nascido Joaquin Rafael Bottom (San Juan, Porto Rico, 28 de outubro de 1974) é um ator,
          </Text>
        </View>
